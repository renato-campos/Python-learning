...
inteira2 = num // 1
inteira3 = trunc(num)
decimal = num - inteira         # perceba o que causa a mantissa, forma como a parte decimal do float é armazenado
decimal2 = num % 1
...
print('A parte inteira é {} e a decimal é {:.3f}'.format(inteira3, decimal2))
